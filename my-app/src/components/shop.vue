      ...
      <div v-if="serviceList.length > 0">
        ...
        >
          <div class="list_title">
            <p @click="hanleEditOrder(citem.descno)" style="color:#00437C">
              订单号：{{ citem.descno }}
            </p>
            <p style="margin-left: 10px;">
              客户名称：{{ citem.CustomerRealName }}
            </p>
          </div>
          ...
          <div class="detail_box">
            ...
            <div class="detail_text">
              <p align="left">首饰成色:{{ citem.shoushi }}</p>
              <p align="left">宝石种类:{{ citem.baoshizl }}</p>
              <p align="left">维修项目:{{ citem.weixiuxm }}</p>
              <p align="left">维修二级:{{ citem.detailStr }}</p>
              <div style="display: flex;">
                <p align="left">总件数:{{ citem.wxCount }}件</p>
                &nbsp;&nbsp;&nbsp;
                <p align="left">总金额:{{ citem.wxPriceTotal }}</p>
              </div>
            </div>
          </div>
            ...
            <van-row type="flex" justify="center" align="center">
              ...
              <van-col span="14" type="flex" justify="space-between">
                <van-button
                  ...
                  >{{ handleBtnText(citem) }}</van-button
                >

                <van-button
                  :disabled="citem.statusid != 6"
                  style="color: white;background-color:#00437C ;margin-left: 5px;"
                  size="small"
                  @click="hanlePickup(citem)"
                  >客户取货</van-button
                >
              </van-col>
            </van-row>
